      ...
      <main className="p-4">
        <article className="bg-white shadow rounded overflow-hidden">
          ...
          <div className="p-5 space-y-3">
            ...
            <h2 className="text-lg font-semibold text-slate-800 leading-tight">Tapetes de 56x56 cm. </h2>
          ...
          <div className="flex p-5 space-x-2">
            ...
            <span className="text-sm font-semibold text-slate-600 leading-4">Luis Ernesto</span>
