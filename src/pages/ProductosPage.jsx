...
const ProductosPage = () => {
  ...
  function renderMain() {
    ...
    return productos.map((producto) => <ProductoCard producto={producto} key={producto.id_producto} />);
   
  }
  return (
    <div>
      <h1 className=" px-2 pb-2 text-3xl text-slate-700 font-bold">Productos</h1>
